...
exports.ChatUploadService = void 0;
const common_1 = require("@nestjs/common");
const storage_service_1 = require("../../shared/storage/storage.service");
let ChatUploadService = class ChatUploadService {
    constructor(storage) {
    ...
    uploadChatFile(file) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.storage.upload(file);
        });
    }
};
exports.ChatUploadService = ChatUploadService;
exports.ChatUploadService = ChatUploadService = __decorate([
